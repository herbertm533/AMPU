...
const ROWS = [
  ...
  ['Samuel','Adams','ma','LW Populist',1722,[2,3,1,0,2,4],1,['Orator','Provincial'],'BLUE'],
  ['Thomas','Jefferson','va','RW Populist',1743,[3,4,2,0,2,2],1,['Egghead','Cosmopolitan'],'BLUE'],
  ['Patrick','Henry','va','Traditionalist',1736,[1,4,2,1,3,3],1,['Orator','Debater','Provincial'],'BLUE'],
  ...
  ['George','Mason','va','Traditionalist',1725,[2,3,2,0,2,3],0,['Predictable'],'BLUE'],
  ...
  ['Charles','Sumner','ma','LW Populist',1811,[2,4,3,0,2,1],4,['Orator','Reformist','Puritan','Cosmopolitan','Predictable'],'RED'],
