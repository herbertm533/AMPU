...
*(The `a0b7ef49` **"Wilson's Vision" 1916-start multiplayer playtest** (batch 29) plays this same hinge — prologue "It is 1916, Woodrow Wilson won re-election narrowly against former Associate Justice Charles Evan Hughes… will Wilson's promise to keep America out of the war be upheld, or will the United States enter the conflict that has dragged on since 1914?" (chunk-001 post 1). Two notes for the game-master. (1) **The game's era-band label for this period is "Era of Hollywood,"** corroborated in-game by a scripted **"Golden Era of Hollywood"** event — Columbia Pictures + MGM formed, CA Gov Stephens / Sen Hiram Johnson, the "Red Baron" WWI ace; chunk-003 lines 455-479 — all era-accurate 1910s-20s texture. (2) **Methodology note (records gap #186, the batch-27 1960 mid-cycle-start problem):** this game was deliberately started at an era's *beginning* rather than its middle — POST 1 opens "Due to the issues in 1960, the group decided that starting at the beginning of an era, rather than the middle, was better." The setup uses **interfaction drafting** and a real-history draft pool that skews **1940s-vintage** (Earl Warren, Eisenhower, Robert Taft, James Farley, Joseph P. Kennedy Sr.; chunk-001 posts 3-4) drawn onto the 1916 board, so treat the *roster* as alt-history even though the 1916 starting facts (Wilson def. Hughes 277-254, decided by California ~3,773 votes, "He Kept Us Out of War"; §5 timeline) are real. Polarity here is the same pre-realignment hinge — do not read 1916 BLUE/RED as modern left/right.)*
...
- **Recent real-history update + the "Era of the Future" era-band edge (batch 29, `c54b7a9d` "Welcome To The Future," a hands-off ALL-CPU run planned 2022→2072).** Two parts. **(a) Real-history grounding past 2020:** the period §10 covers now extends through real events the doc previously stopped short of — the **2022 midterms** (Republicans took the House 222-213; Democrats held the Senate 51-49 after the Georgia runoff; the anticipated "red wave" did not materialize) and the **2024 election → Trump's nonconsecutive second term** (Trump def. Harris 312-226 EV, 49.8% popular vote — first GOP popular-vote win since 2004; a nonconsecutive second term, like Cleveland in 1892). ([Wikipedia — 2022 US elections](https://en.wikipedia.org/wiki/2022_United_States_elections), [Wikipedia — 2024 election](https://en.wikipedia.org/wiki/2024_United_States_presidential_election), [National Archives — 2024 Electoral College](https://www.archives.gov/electoral-college/2024)) **[consensus]** *Caveat:* the thread itself is from 2022 (forum timestamps 2021-22) and so predates the 2024 result — its captured corpus covers only the **2022 setup + first 2022-2024 turn** (real 2022 House leadership — Hoyer/Clyburn/Jeffries/AOC, chunk-001 posts 3-22; Biden as president, cabinet confirmations, chunk-006/007). The march to 2072 is the *stated plan*, not reached in-corpus (chunk-001 post 1: "why I'm planning to end in 2072… the entire list of politicians by then will be all randomly generated"). **(b) The "Era of the Future" is the terminal era band of the game's era model — and it is a PARTIAL STUB, not fully built.** A developer reply states it plainly: "The only issue is that Era of the Future isn't completely fleshed out… Events are fairly solid. Mainly I need more proposals." (chunk-001 post 6). So: **scripted-events ≈ in place, proposals/legislation content ≈ incomplete; roster assumed all-randomly-generated by ~2072** as the real-politician record runs out (consistent with the §10 note above on generated-vs-real drafts). **For the game-master/tech-lead:** everything past ~2025 in any Era-of-the-Future run is the **engine's own projected fiction — there is no real history to ground it** (do not treat its officeholders/events as historical). And note a cross-batch methodology echo: this all-CPU run independently re-learned the same lesson the 1916 game (batch 29, §5) acted on — chunk-007 post 378, "There is only one scripted event capable of occurring right now -- that's what I get for starting a game at the tail end of an era." Both threads converge: era *boundaries* (very start or very end) have thin scripted-event density; start mid-game-but-at-an-era's-beginning.
