...
new one. **Total author-before-build RULES items: 13** (UNCHANGED)
...
Why the order is what it is — the tech-lead's binding calls (§9 batch-29 lead +
