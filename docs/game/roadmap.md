...
before-build). **Total author-before-build items: 13** (DH-1, #10/#84, §25.9, DH-12,
DH-13, DH-14, DH-15, DH-25, DH-33, DH-41, **DH-49**, **DH-54**, **#122 pardon
mechanics NEW batch-12**). **Decision-gated category — held at 2 by batch 11** (batch 10 introduced it
...
Designer-gated 9 items (NEW this batch). **★ Batch 12 adds the (B) sub-bucket; (A)
stays the batch-11 set.**
...
Why the order is what it is — the tech-lead's binding calls (§9 batch-12 lead +
§9.6 batch-12 + §9 batch-11 lead + §9 batch-10 lead + §9.1.9 + §9 batch-9 lead +
§9.1.5 + §9.1.8 + §9.1.3 + §9.6 + §9.1.6 + §9.1.7 + §6.6.1). **Batch 12 is DESIGNER-
RULINGS INTEGRATION + QW0 FULLY CLOSES + ONE M-rework + 19 sized Ted-rulings slot
into existing epics, NOT a re-sequence** — the batch-12 leads come first (below),
then batch-11, then batch-10, then batch-9, then batch-8, then batch-7, then the
carried batch-5 leads. **The order itself is UNCHANGED — the TOP OF THE QUEUE is
QW0 (constant=4 + alt-state guard, ship FIRST) → K0/K2 → K3/K4 +
`scenarioBoot`/`BootSheet` → `scenario1788` (E1) …**
