...
fix WITHIN the CPU/war track.** The batch-21 lead comes first (below), then batch-20, then
batch-19, then batch-18, then batch-17, then batch-16, then
