...
Why the order is what it is — the tech-lead's binding calls (§9 batch-17 lead +
§9 batch-16 lead +
...
NO new author-before-build or Decision-gated items (batch 18 nets 0).** The batch-18 lead
comes first (below), then batch-17, then batch-16, then batch-15, then batch-14, then
batch-13, then batch-12, then batch-11, then batch-10, then batch-9, then batch-8, then
batch-7, then the carried batch-5 leads.
