...
flat-vs-bias is a tuning dial); DH-65 is dataset maintenance (E18d).**
...
re-sequence, NO new keystone, NO new author-before-build items.** The batch-17 lead comes
first (below), then batch-16, then batch-15, then batch-14, then batch-13, then batch-12,
then batch-11, then batch-10, then batch-9, then batch-8, then batch-7, then the carried
batch-5 leads.
